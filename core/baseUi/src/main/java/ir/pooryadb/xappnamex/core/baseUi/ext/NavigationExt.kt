 ...
 *
 * link: https://github.com/SmartToolFactory/NavigationComponents-Tutorials/tree/master/Tutorial5-3NavigationUI-BottomNavigation-NestedNavigation
 */
...
private fun BottomNavigationView.setupItemReselected(
    ...
    setOnNavigationItemReselectedListener { item ->
        ...
        navController.popBackStack(
            navController.graph.findStartDestination().id, false
        )
    }
}
